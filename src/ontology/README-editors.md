These notes are for the EDITORS of TXPO
...
Make sure you have an ID range in the [idranges file](TXPO-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [TXPO-edit.owl](TXPO-edit.owl)

** DO NOT EDIT TXPO.obo OR TXPO.owl in the top level directory **

[../../TXPO.owl](../../TXPO.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/txpo-ontology/TXPO) for details.
 ...
 * [TXPO-idranges.owl](TXPO-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/TXPO_terms.txt file
...
Note: the TXPO_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as TXPO.owl and TXPO.obo and places
 ...
 * https://github.com/txpo-ontology/TXPO/releases
 * https://github.com/txpo-ontology/TXPO/releases/new
...
what is in the `owl:versionIRI` of the derived TXPO.owl (`data-version` in
TXPO.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/TXPO.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/TXPO/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/txpo-ontology/TXPO.svg?branch=master)](https://travis-ci.org/txpo-ontology/TXPO)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/txpo-ontology](https://travis-ci.org/profile/txpo-ontology)
 2. click the "Sync account" button
 3. Click the tick symbol next to TXPO
