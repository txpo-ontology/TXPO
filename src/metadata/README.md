 ...
 * [TXPO.yml](TXPO.yml)
     * Determines how your purl.obolibrary.org/obo/TXPO/ redirects will be handled
     ...
     * Paste in the contents of [TXPO.yml](TXPO.yml)
 ...
 * [TXPO.md](TXPO.md)
     ...
     * Paste in the contents of [TXPO.md](TXPO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
